                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">会员管理 > 修改会员 </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <form action="member.let?type=modify" method="post">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="10%">用户名：</td>
                                                        <td width="20%"><input class="text" type="text" name="name" value="${member.name}" required/></td>
                                                        <td class="err">长度6~15个字符</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
